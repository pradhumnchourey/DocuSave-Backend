...
public class PdfController {
    ...
    @PostMapping("/upload")
    public ResponseEntity<String> uploadPdf(@RequestParam("file") MultipartFile file, @RequestParam("docType") String docType,
        ...
        try {
            ...
            pdfService.savePdf(file.getOriginalFilename(), content, docType, userId);
